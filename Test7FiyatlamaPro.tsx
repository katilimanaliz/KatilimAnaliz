...
💼 Konuyla ilgili daha fazla bilgi için bölge veya segment temsilcinizle iletişime geçebilirsiniz.`,tip:"bulunamadi"};
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",height:"calc(100vh - 182px)",background:"#0F1923"}}>
      {!sohbetBasladi?(
        <div style={{flex:1,overflowY:"auto",padding:"16px 14px"}}>
          ...
          <div style={{
            ...
            <p style={{margin:"12px 0 0",fontSize:10,color:"rgba(255,255,255,0.3)",textAlign:"center"}}>📄 ZK Talimatı (17.06.2026) & Ücretler Tebliği (2020/4) bilgi tabanı yüklü</p>
          </div>
...
const MENU = {
  ...
  fonGetiriIzleme:{title:"Yatırım Fonları Getiri İzleme",back:"piyasaMenu"},
  bistHisseTarayici:{title:"BİST Veri İzleme",back:"piyasaMenu"},
  ...
  tmKomisyon:{title:"TM Komisyon Hesaplama",back:"hesaplaMenu"},
  ...
  piyasaHaberleri:{title:"Piyasa Haberleri",back:"piyasaMenu"},
...
const ALT_BAR_SEKMELERI = [
  ...
  {tab:"yapayzeka", key:"asistan",     tip:"yapayzeka", label:"Yapay Zeka"},
...
function AltBarIcon({tip,aktif}:{tip:string,aktif:boolean}){
  const renk = aktif ? "#3B82F6" : "rgba(255,255,255,0.5)";
...
const HESAPLA_ARAC_LISTESI = [
  ...
  {key:"tmKomisyon",         icon:"📄", label:"TM Komisyon Hesaplama",                kat:"ticari"},
...
function App(){
  ...
  const [favoriler,setFavoriler]=useState<string[]>(()=>{
    ...
    return ["spotFinansman","esnekOdemePlanlari","katkiPayi","taksitliTicari"];
  });
  ...
  return(
    <div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Text',sans-serif",background:C.bg,minHeight:"100vh",maxWidth:430,margin:"0 auto"}}>
          ...
          <div>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
              <div>
                ...
                <p style={{margin:"3px 0 0",fontSize:11,color:"rgba(255,255,255,0.45)"}}>Katılım Analiz Platformu</p>
              </div>
            </div>
            {/* Tarih & Saat */}
      ...
      <div style={{paddingTop:0}}>
        ...
        {/* ── HOME ── */}
        {screen==="home"&&(
          <div style={{background:"#0F1923",height:"calc(100vh - 112px)",padding:"10px 12px 0",paddingBottom:70,boxSizing:"border-box",display:"flex",flexDirection:"column",overflowY:"auto"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:6,marginBottom:14}}>
              <PiyasaOzetiKart ad="USD/TRY" sembol="USDTRY=X" dec={2} onTikla={()=>setSeciliKur({kod:"USD",ad:"USD/TRY",sembol:"USDTRY=X"})}/>
              <PiyasaOzetiKart ad="EUR/TRY" sembol="EURTRY=X" dec={2} onTikla={()=>setSeciliKur({kod:"EUR",ad:"EUR/TRY",sembol:"EURTRY=X"})}/>
              <PiyasaOzetiKart ad="ALTIN/GR" sembol="GRAM_ALTIN" dec={2} onTikla={()=>setSeciliKur({kod:"Altın/TRY (Gram)",ad:"Altın/TRY (Gram)",sembol:"GRAM_ALTIN"})}/>
              <PiyasaOzetiKart ad="BIST 100" sembol="XU100.IS" dec={0} onTikla={()=>setSeciliKur({kod:"BIST 100",ad:"BIST 100",sembol:"XU100.IS"})}/>
            </div>
              ...
              {favoriler.map(key=>{
                ...
                return(
                  <div key={key} onClick={()=>nav(item.key)} style={{
                    background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.08)",
                    borderRadius:14,padding:"12px 6px",cursor:"pointer",minHeight:88,
                    display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:6,
                  }}>
                    <div style={{width:38,height:38,borderRadius:19,background:"rgba(59,130,246,0.15)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>{item.icon}</div>
                    <span style={{fontSize:10,fontWeight:700,color:"#E8F0FA",textAlign:"center",lineHeight:1.25}}>{item.label}</span>
                  </div>
                );
              })}
              {favoriler.length===0&&(
                <div onClick={()=>setFavoriDuzenleAcik(true)} style={{gridColumn:"1 / -1",textAlign:"center",padding:"16px 0",color:"rgba(255,255,255,0.35)",fontSize:12,cursor:"pointer"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:8,marginBottom:14}}>
              {[
                ...
                {key:"piyasaHaberleri",   icon:"📡", label:"Haberler"},
                ...
                <div key={c.key} onClick={()=>nav(c.key)} style={{
                  ...
                  <div style={{width:38,height:38,borderRadius:19,background:"rgba(74,222,128,0.15)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>{c.icon}</div>
                  <span style={{fontSize:10,fontWeight:700,color:"#E8F0FA",textAlign:"center",lineHeight:1.25}}>{c.label}</span>
                </div>
              ))}
            </div>
        ...
        {screen==="hesaplaMenu"&&(()=>{
          ...
          return(
          <div style={{background:"#0F1923",height:"calc(100vh - 112px)",padding:"12px 12px 0",paddingBottom:70,boxSizing:"border-box",overflowY:"auto"}}>
            {/* Arama çubuğu */}
              ...
              <>
                ...
                {piyasaTabloFiltre==="borsa"&&(
                  <div onClick={()=>nav("bistHisseTarayici")} style={{
                    ...
                    <span style={{fontSize:22}}>📊</span>
                    <div style={{flex:1}}>
                      <p style={{margin:0,fontSize:13,fontWeight:800,color:"#fff"}}>BİST Veri İzleme</p>
      ...
      {["home","hesaplaMenu","piyasaMenu","araclarMenu","asistan","profil"].includes(screen)&&(
        <div style={{position:"fixed",left:0,right:0,bottom:0,zIndex:90,display:"flex",justifyContent:"center"}}>
          <div style={{
            width:"100%",maxWidth:430,background:"#152330",borderTop:"1px solid rgba(255,255,255,0.08)",
            display:"flex",boxShadow:"0 -4px 16px rgba(0,0,0,0.35)",
            ...
            {ALT_BAR_SEKMELERI.map(t=>{
              ...
              return (
                <div key={t.tab} onClick={()=>nav(t.key)} style={{
                  ...
                  gap:2,padding:"8px 2px 6px",cursor:"pointer",
                }}>
                  <AltBarIcon tip={t.tip} aktif={aktif}/>
                  <span style={{fontSize:9,fontWeight:aktif?800:600,color:aktif?"#3B82F6":"rgba(255,255,255,0.5)",whiteSpace:"nowrap"}}>{t.label}</span>
                </div>
              );
            })}
          </div>
