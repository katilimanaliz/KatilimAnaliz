...
function KurGrafikModal({kur, onClose}:{kur:any, onClose:()=>void}){
  ...
  const sembol=sembolMap[kur.kod]||kur.kod;
            ...
            <>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10,marginBottom:16}}>
                <div style={{background:"#F8FAFB",borderRadius:10,padding:"10px 12px"}}>
                  <p style={{margin:0,fontSize:10,color:"#6B7B8D",fontWeight:600}}>GÜNCEL</p>
                  <p style={{margin:"4px 0 0",fontSize:14,fontWeight:800,color:"#1C2B3A",fontFamily:"monospace"}}>{fmt2(veri.guncelFiyat)}</p>
                </div>
                <div style={{background:"#F8FAFB",borderRadius:10,padding:"10px 12px"}}>
                  <p style={{margin:0,fontSize:10,color:"#6B7B8D",fontWeight:600}}>EN DÜŞÜK</p>
                  <p style={{margin:"4px 0 0",fontSize:14,fontWeight:800,color:"#1C3A5E",fontFamily:"monospace"}}>{fmt2(minF)}</p>
                </div>
                <div style={{background:"#F8FAFB",borderRadius:10,padding:"10px 12px"}}>
                  <p style={{margin:0,fontSize:10,color:"#6B7B8D",fontWeight:600}}>EN YÜKSEK</p>
                  <p style={{margin:"4px 0 0",fontSize:14,fontWeight:800,color:"#1C3A5E",fontFamily:"monospace"}}>{fmt2(maxF)}</p>
                </div>
              </div>
