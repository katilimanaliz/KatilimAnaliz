...
function HisseAvatar({ticker, boyut=42}:{ticker:string, boyut?:number}){
  ...
  return (
    <div style={{width:boyut,height:boyut,borderRadius:boyut*0.28,flexShrink:0,overflow:"hidden",background:hata?avatarRenk(ticker):"#fff"}}>
      {!hata ? (
      ...
      <div style={{
        ...
        <div style={{display:"flex"}}>
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:14.5,fontWeight:800,fontFamily:"monospace"}}>{hisseIstatistik.toplam}</div>
          </div>
          <div style={{flex:1}}>
          ...
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:14.5,fontWeight:800,fontFamily:"monospace"}}>{fmtByk(hisseIstatistik.hacimToplam)}</div>
          </div>
        </div>
      ...
      <div className="piyasa-scroll" style={{display:"flex",gap:8,overflowX:"auto",marginBottom:14,paddingBottom:2}}>
        {["BIST 100","BIST 30","BIST 50"].map(ad=>(
          <div key={ad} style={{flex:"0 0 108px",background:"rgba(255,255,255,0.05)",border:`1px solid ${C.border}`,borderRadius:14,padding:"10px 12px"}}>
            ...
            <div style={{fontSize:15,fontWeight:800,fontFamily:"monospace",margin:"4px 0 3px"}}>
