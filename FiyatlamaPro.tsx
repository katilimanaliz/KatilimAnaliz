...
function Asistan({nav, settings}:{nav:any, settings?:any}){
  ...
  const MODUL_MAP=[
    ...
    {keys:["kasa hesabı","kasa oran"],screen:"kasaOranAnalizi",label:"Kasa Hesabı Oran Analizi"},
...
const MENU_ARAMA_LIST=[
  ...
  {key:"kasaOranAnalizi",    label:"Kasa Hesabı Oran Analizi",             icon:"🏛️", grup:"Katılım Hesabı"},
