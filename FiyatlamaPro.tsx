...
// ─── PİYASA HABERLERİ (DİNAMİK — TÜRKİYE + ABD/AVRUPA) ─────────────────────────
function PiyasaHaberleri(){
  ...
  const filtreli = ulkeFiltre==="tumu" ? haberler : haberler.filter(h=>h.ulke===ulkeFiltre);
    ...
    <div style={{background:"#0B0E14",minHeight:"100vh",paddingBottom:32}}>
      ...
      <div style={{margin:"0 16px",padding:"10px 14px",background:"#151823",borderRadius:10}}>
        <p style={{margin:0,fontSize:10,color:"#6B7280",lineHeight:1.5}}>
          📡 Veriler Forex Factory ekonomik takviminden otomatik çekilmektedir. Türkiye, ABD ve Avrupa'ya ait yüksek/orta etkili olaylar gösterilmektedir. Yatırım tavsiyesi değildir.
        </p>
      </div>
    </div>
  );
