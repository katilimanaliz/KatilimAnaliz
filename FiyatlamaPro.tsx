...
function PiyasaOzetiKart({ad,sembol,paraOnek,dec,onTikla}:{ad:string,sembol:string,paraOnek?:string,dec:number,onTikla:()=>void}){
  ...
  const kucukIkon = (()=>{
    ...
    if(a.includes("USD")||a.includes("DOLAR")) return "💵";
    if(a.includes("EUR")) return "🇪🇺";
    if(a.includes("GBP")||a.includes("STERLİN")) return "🇬🇧";
    if(a.includes("ALTIN")||a.includes("ALTİN")) return "🥇";
    if(a.includes("GÜMÜŞ")||a.includes("GUMUS")) return "🥈";
    if(a.includes("BITCOIN")||a.includes("BTC")) return "₿";
    if(a.includes("ETHEREUM")||a.includes("ETH")) return "Ξ";
    if(a.includes("BIST")) return "📊";
    if(a.includes("BRENT")||a.includes("PETROL")||a.includes("WTI")) return "🛢️";
    if(a.includes("S&P")||a.includes("NASDAQ")||a.includes("DOW")||a.includes("DAX")) return "📈";
    return null;
  })();
  ...
  return(
    <div className="press-card" onClick={onTikla} style={{
      ...
      {kucukIkon&&<span style={{position:"absolute",top:8,right:9,fontSize:12,opacity:0.85,lineHeight:1}}>{kucukIkon}</span>}
          ...
          <div>
            <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:10,marginBottom:4}}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:5,flexShrink:0,maxWidth:150,textAlign:"right"}}>
                ...
                <div>
                  <p style={{margin:0,fontSize:9,fontWeight:700,color:"rgba(255,255,255,0.85)",lineHeight:1.3}}>📋 YASAL UYARI</p>
                  <p style={{margin:"1px 0 0",fontSize:7.5,color:"rgba(255,255,255,0.5)",lineHeight:1.3}}>Bilgilendirme amaçlıdır, hukuki sonuç doğurmaz</p>
                </div>
              </div>
            </div>
