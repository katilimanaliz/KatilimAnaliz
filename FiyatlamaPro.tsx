  ...
  const PIYASA_GRUPLARI=[
    ...
    },
    {
      ...
      items:[
        ...
        {ad:"Altın (Ons/USD)",    sembol:"XAUUSD=X",  para:"$", dec:2},
        {ad:"Gümüş (Ons/USD)",   sembol:"XAGUSD=X",  para:"$", dec:3},
        ...
        {yukleniyor?(
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            {gosterKurlar.map((k,i)=>(
              <div key={i} onClick={()=>{
                  const sembolMap:any={"USD/TRY":"USDTRY=X","EUR/TRY":"EURTRY=X","GBP/TRY":"GBPTRY=X","Altın/TRY (Gram)":"GRAM_ALTIN","Gümüş/TRY (Gram)":"GRAM_GUMUS","Ons Altın/USD":"XAUUSD=X"};
...
function KurGrafikModal({kur, onClose}:{kur:any, onClose:()=>void}){
  ...
  const sembolMap:any={
    ...
    "Altın (g)":"XAUUSD=X","Gümüş (g)":"XAGUSD=X","BTC":"BTC-USD",
    "USD/TRY":"USDTRY=X","EUR/TRY":"EURTRY=X","GBP/TRY":"GBPTRY=X",
    "Altın/TRY (Gram)":"GRAM_ALTIN","Gümüş/TRY (Gram)":"GRAM_GUMUS","Ons Altın/USD":"XAUUSD=X",
  };
...
const PIYASA_TABLO_VERISI:any = {
  ...
  emtia: [
    {ad:"Altın (Ons)",   sembol:"XAUUSD=X", dec:2, paraOnek:"$"},
    {ad:"Gümüş (Ons)",   sembol:"XAGUSD=X", dec:3, paraOnek:"$"},
          ...
          <div style={{background:"#0F1923",padding:"10px 12px 0",paddingBottom:92,boxSizing:"border-box",display:"flex",flexDirection:"column",overflowY:"auto"}}>
            ...
            <div className="piyasa-scroll" style={{display:"flex",overflowX:"auto",gap:6,marginBottom:14,scrollSnapType:"x mandatory",WebkitOverflowScrolling:"touch",paddingBottom:2}}>
              {[
                ...
                {ad:"GÜMÜŞ",    sembol:"XAGUSD=X",   dec:2, kod:"Gümüş (Ons)"},
