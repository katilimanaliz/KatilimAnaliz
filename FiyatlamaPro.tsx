...
const C = {
  ...
  label:"#F1F5F9", sub:"rgba(255,255,255,0.55)", border:"rgba(255,255,255,0.12)", sep:"rgba(255,255,255,0.3)",
};
            ...
            <div style={{flex:1,overflowY:"auto",padding:"14px 16px 28px"}}>
              ...
              <div style={{overflowX:"auto"}}>
                <table style={{borderCollapse:"collapse",width:"100%",minWidth:300}}>
                  ...
                  <tbody>
                    {TUZEL_TABLO.map((b,i)=>(
                      <tr key={i} style={{background:i%2===0?"#fff":"rgba(224,165,61,0.12)"}}>
      ...
      <div style={{paddingTop:0}}>
        ...
        {screen==="home"&&(
          <div style={{background:"#0F1923",height:"calc(100dvh - 112px)",padding:"10px 12px 0",paddingBottom:70,boxSizing:"border-box",display:"flex",flexDirection:"column",overflowY:"auto"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:8,marginBottom:14}}>
              {[
                {key:"bistHisseTarayici", icon:"📊", label:"BİST Veri İzleme"},
      ...
      {["home","hesaplaMenu","piyasaMenu","araclarMenu","asistan","profil"].includes(screen)&&(
        <div style={{position:"fixed",left:0,right:0,bottom:0,zIndex:90,display:"flex",justifyContent:"center"}}>
          <div style={{
            ...
            background:"rgba(17,27,38,0.82)",backdropFilter:"blur(20px) saturate(180%)",WebkitBackdropFilter:"blur(20px) saturate(180%)",
            borderTop:"0.5px solid rgba(255,255,255,0.1)",
            display:"flex",boxShadow:"0 -8px 24px rgba(0,0,0,0.28)",
