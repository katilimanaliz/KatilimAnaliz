...
function Sozluk(){
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",flex:1,minHeight:0,background:"#0F1923"}}>
      {/* Arama */}
...
function App(){
  ...
  return(
    <>
      ...
      `}</style>
    <div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Text',sans-serif",background:"#0F1923",height:"100dvh",maxWidth:430,margin:"0 auto",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      {/* header */}
      <div style={{background:"#0F1923",padding:"44px 20px 20px",flexShrink:0,zIndex:50}}>
        {screen==="home"?(
          <div>
      ...
      <div style={{paddingTop:0,flex:1,minHeight:0,display:"flex",flexDirection:"column"}}>

        {/* ── HOME ── */}
        {screen==="home"&&(
          <div style={{background:"#0F1923",flex:1,minHeight:0,padding:"10px 12px 0",paddingBottom:70,boxSizing:"border-box",display:"flex",flexDirection:"column",overflowY:"auto"}}>
        ...
        {screen==="hesaplaMenu"&&(()=>{
          ...
          return(
          <div style={{background:"#0F1923",flex:1,minHeight:0,padding:"12px 12px 0",paddingBottom:70,boxSizing:"border-box",overflowY:"auto"}}>
            {/* Arama çubuğu */}
