...
function App(){
  ...
  // Web'de kolon 430px'te sabitti; geniş ekranlarda hem kolon genişletiliyor
  // hem de yanlardaki boşluk düz siyah yerine yumuşak bir degrade ile
  // çerçeveleniyor. Native uygulama etkilenmez.
  const [genisEkran,setGenisEkran]=useState(()=>{
    try{ return !IS_NATIVE && window.innerWidth>=1024; }catch{ return false; }
  });
  useEffect(()=>{
    if(IS_NATIVE) return;
    const f=()=>setGenisEkran(window.innerWidth>=1024);
  ...
  return(
    <>
      ...
      `}</style>
    <div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Text',sans-serif",background:"#0F1923",minHeight:"100dvh",maxWidth:IS_NATIVE?680:(genisEkran?760:430),margin:"0 auto",
      ...
      {["home","hesaplaMenu","piyasaMenu","araclarMenu","asistan","profil"].includes(screen)&&(
        <div style={{
          ...
          <div style={{
            width:"100%",maxWidth:IS_NATIVE?560:(genisEkran?600:402),
