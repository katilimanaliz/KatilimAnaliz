              ...
              {!kurulumBannerKapali&&(
                <div style={{position:"relative",flexShrink:0}}>
                  <button onClick={()=>setKurulumKilavuzuAcik(true)} style={{
                    ...
                    padding:"7px 9px",borderRadius:11,border:"1px solid rgba(91,155,216,0.3)",
                    background:"rgba(91,155,216,0.15)",cursor:"pointer",
                  }}>
                    <span style={{fontSize:15,lineHeight:1}}>📲</span>
                    <span style={{fontSize:7,fontWeight:800,color:"#9FC1EA",lineHeight:1.15,textAlign:"center",whiteSpace:"nowrap"}}>Ana Ekrana<br/>Ekleme Kılavuzu</span>
                  </button>
                  <button onClick={(e)=>{
                    e.stopPropagation();
                    setKurulumBannerKapali(true);
                    try{ localStorage.setItem("katilimAnaliz_kurulumBannerKapali_v1","1"); }catch{}
                  }} style={{position:"absolute",top:-5,right:-5,background:"#1C2A38",border:"1px solid rgba(255,255,255,0.15)",width:17,height:17,borderRadius:9,color:"rgba(255,255,255,0.6)",fontSize:10,lineHeight:1,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:0}}>×</button>
                </div>
              )}
            </div>
