...
function FonGetiriIzleme({ settings }) {
  ...
  const [sirala,      setSirala]     = useState<string>("yillikD");
    ...
    return siralanmis
      .filter(f=>{
        ...
        const yOk=filtreYon==="Tümü"||(
              ...
              filtreYon==="Para"    ? (kat.includes("PARA")     || ad.includes("PARA PİYASASI")):
              filtreYon==="Borçlanma"?(kat.includes("BORÇ")     || ad.includes("BORÇ")):
              filtreYon==="Karma"   ? (kat.includes("DEĞİŞKEN") || kat.includes("KARMA") || ad.includes("DEĞİŞKEN")):
              filtreYon==="Sepet"   ? (kat.includes("SEPET")    || ad.includes("SEPET")):
              filtreYon==="Altın"   ? (kat.includes("ALTIN")    || kat.includes("KIYMETLİ") || ad.includes("ALTIN") || ad.includes("GÜMÜŞ")):
