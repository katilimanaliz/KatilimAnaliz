      ...
      <div style={{
        ...
        <div style={{display:"flex"}}>
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:14.5,fontWeight:800,fontFamily:"monospace",color:"#fff"}}>{hisseIstatistik.toplam}</div>
          </div>
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:14.5,fontWeight:800,fontFamily:"monospace",color:C.green}}>{hisseIstatistik.artan}</div>
          </div>
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:14.5,fontWeight:800,fontFamily:"monospace",color:C.red}}>{hisseIstatistik.azalan}</div>
          </div>
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:14.5,fontWeight:800,fontFamily:"monospace",color:"#fff"}}>{fmtByk(hisseIstatistik.hacimToplam)}</div>
          </div>
        </div>
              ...
              {favoriler.map(key=>{
                ...
                return(
                  <div className="press-tile" key={key} onClick={()=>nav(item.key)} style={{
                    flex:"0 0 110px",scrollSnapAlign:"start",position:"relative",overflow:"hidden",
                    background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.08)",
                    borderRadius:26,padding:"16px 8px",cursor:"pointer",minHeight:122,
                    display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:10,
                  }}>
                    {renk&&<div style={{position:"absolute",top:0,left:14,right:14,height:3,borderRadius:"0 0 3px 3px",background:`linear-gradient(90deg,transparent,${renk},transparent)`}}/>}
                    <div style={{height:56,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                      <Icon k={item.key} size={40} color="#5B9BD8" style={{filter:"drop-shadow(0 0 7px rgba(91,155,216,0.55))"}}/>
                    </div>
                    <span style={{fontSize:12,fontWeight:700,color:"#E8F0FA",textAlign:"center",lineHeight:1.25}}>{item.label}</span>
                  </div>
                );
              })}
              {favoriler.length===0&&(
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
              {[
                ...
                <div className="press-tile" key={c.key} onClick={()=>nav(c.key)} style={{
                  background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.08)",
                  borderRadius:26,padding:"18px 10px",cursor:"pointer",minHeight:120,position:"relative",overflow:"hidden",
                  display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:10,
                }}>
                {renk&&<div style={{position:"absolute",top:0,left:14,right:14,height:3,borderRadius:"0 0 3px 3px",background:`linear-gradient(90deg,transparent,${renk},transparent)`}}/>}
                <div style={{height:58,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                  <Icon k={c.key} size={42} color="#5B9BD8" style={{filter:"drop-shadow(0 0 7px rgba(91,155,216,0.55))"}}/>
                </div>
                  <span style={{fontSize:13,fontWeight:700,color:"#E8F0FA",textAlign:"center",lineHeight:1.3}}>{c.label}</span>
                </div>
                );})}
            </div>
