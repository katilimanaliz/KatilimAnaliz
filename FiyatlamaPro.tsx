              ...
              {favoriler.map(key=>{
                ...
                return(
                  <div key={key} onClick={()=>nav(item.key)} style={{
                    ...
                    <div style={{width:56,height:56,borderRadius:28,background:"rgba(59,130,246,0.15)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:28,flexShrink:0}}>{item.icon}</div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
              {[
                ...
                <div key={c.key} onClick={()=>nav(c.key)} style={{
                  ...
                  <div style={{width:58,height:58,borderRadius:29,background:"rgba(74,222,128,0.15)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:30,flexShrink:0}}>{c.icon}</div>
