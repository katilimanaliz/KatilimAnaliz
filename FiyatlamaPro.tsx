...
function App(){
  ...
  // Ana sayfa "Yaklaşan Takvim" — önümüzdeki 3 gün, Türkiye ekonomik takvimi
  const yaklasanTakvim = useMemo(() => {
    const bugun = new Date(); bugun.setHours(0,0,0,0);
    const bitis = new Date(bugun); bitis.setDate(bitis.getDate()+3); bitis.setHours(23,59,59,999);
    return turkiyeStatikTakvim()
      .filter((e:any) => { const t=new Date(e.tarih); return t>=bugun && t<=bitis; })
