  ...
  return(
    <div style={{background:"#0F1923",padding:"12px 14px 92px",minHeight:"100%"}}>
      ...
      {KATILIM_BANKALARI.map((b,i)=>(
        <div key={i} onClick={()=>setSecili(b)} style={{
          ...
          <div style={{background:"#0F1923",padding:"10px 12px 0",paddingBottom:92,boxSizing:"border-box",display:"flex",flexDirection:"column",overflowY:"auto"}}>
              ...
              {favoriler.map(key=>{
                ...
                return(
                  <div key={key} onClick={()=>nav(item.key)} style={{
                    ...
                    <div style={{height:56,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><Icon k={item.key} size={28}/></div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
              {[
                ...
                <div style={{height:58,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><Icon k={c.key} size={30}/></div>
                ...
                <div key={kat.id} style={{marginBottom:16}}>
                  ...
                  {items.map(it=>(
                    <div key={it.key} onClick={()=>nav(it.key)} style={{
                      ...
                      <span style={{width:26,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><Icon k={it.key}/></span>
          ...
          <div style={{background:"#0F1923",padding:"12px 12px 0",paddingBottom:92,boxSizing:"border-box",overflowY:"auto"}}>
            {[
              ...
              <div key={c.key} onClick={()=>nav(c.key)} style={{
                ...
                <div style={{width:46,height:46,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><Icon k={c.key} size={24}/></div>
                <div style={{flex:1,minWidth:0}}>
