            ...
            <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:10,marginBottom:4}}>
              <div style={{display:"flex",alignItems:"center",gap:7,flexShrink:0}}>
                ...
                <div style={{display:"flex",flexDirection:"column"}}>
                  <span style={{fontSize:14,fontWeight:700,letterSpacing:"-0.005em",fontFamily:"Georgia,'Iowan Old Style','Times New Roman',serif",background:"linear-gradient(100deg,#EAF1FA 0%,#C9D9EE 60%,#B8C9E8 100%)",WebkitBackgroundClip:"text",backgroundClip:"text",color:"transparent"} as any}>Katılım Plus</span>
