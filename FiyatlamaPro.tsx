...
const KATILIM_BANKALARI = [
  {
    ...
    site:"albaraka.com.tr", adres:"Büyükdere Cad. No:201, Levent / Beşiktaş, İstanbul",
  ...
  },
  {
    ...
    site:"turkiyefinans.com.tr", adres:"Büyükdere Cad. No:159-163, Esentepe-Şişli, İstanbul",
  ...
  },
  {
    ...
    site:"ziraatkatilim.com.tr", adres:"Hobyar Mah. Şeyhülislam Hayri Efendi Cad. No:12/1, Bahçekapı-Fatih, İstanbul",
  ...
  },
  {
    ...
    site:"vakifkatilim.com.tr", adres:"Büyükdere Cad. No:131, Levent-Beşiktaş, İstanbul",
  ...
  },
  {
    ...
    site:"emlakkatilim.com.tr", adres:"İstanbul",
  ...
  },
  {
    ...
    site:"hayatfinans.com.tr", adres:"İstanbul",
  ...
  },
  {
    ...
    tur:"Dijital", merkez:"İstanbul", sermaye:"Özel (dijital)",
    site:"tom.com.tr", adres:"İstanbul",
  ...
  },
  {
    ...
    site:"dunyakatilim.com.tr", adres:"Esentepe Mah. Büyükdere Cad. No:195, Şişli, İstanbul",
  ...
  return(
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.7)",zIndex:600,display:"flex",alignItems:"flex-end"}} onClick={onClose}>
      <div style={{background:C.card,borderRadius:"20px 20px 0 0",width:"100%",maxHeight:"75vh",display:"flex",flexDirection:"column"}} onClick={e=>e.stopPropagation()}>
        ...
        {/^TLREF/.test(ad)&&(
          <div style={{margin:"10px 20px 0",padding:"9px 12px",background:"rgba(139,92,246,0.1)",borderRadius:10,borderLeft:"3px solid #8B5CF6"}}>
            <p style={{margin:0,fontSize:10.5,color:C.sub,lineHeight:1.5}}>⚠️ Bu değer, BIST TLREF Endeksi'nin günlük değişiminden türetilen bir tahmindir; resmî BIST TLREF oranı değildir. Hafta sonu ve tatil sonrası günlerde (özellikle Pazartesi) BIST'in yayımladığı orandan sapabilir.</p>
          </div>
        )}
    ...
    <div style={{padding:"0 16px 32px"}}>
      ...
      {SABIT.map((kat,ki)=>(
        <div key={ki} style={{marginBottom:16}}>
          ...
          {kat.kategori==="Referans Oranlar (BIST)"&&(
            <p style={{margin:"6px 4px 0",fontSize:9.5,color:C.sub,lineHeight:1.4,fontStyle:"italic"}}>
              ⚠️ TLREF/TLREFK, BIST TLREF Endeksi'nin günlük değişiminden türetilen tahmini değerlerdir; resmî BIST oranından özellikle Pazartesi ve tatil sonrası günlerde sapabilir.
            </p>
          )}
        </div>
      ))}
...
function App(){
  ...
  const anaSayfaHaberGetir=useCallback((manuel=false)=>{
    ...
    fetch("/api/finans-haberleri")
      ...
      .catch(()=>{})
      .finally(()=>{ if(manuel) setSonHaberlerYenileniyor(false); });
  },[]);
  useEffect(()=>{
    anaSayfaHaberGetir();
