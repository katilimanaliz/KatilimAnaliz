...
function App(){
  ...
  useEffect(()=>{
    ...
    PushNotifications.addListener("registration", (token) => {
      ...
      // TODO: Bu token'ı backend'e gönderip veritabanında sakla —
      // ileride bu kullanıcıya bildirim yollamak için gerekecek.
      // Örnek: fetch(`${API_BASE}/api/push-token-kaydet`, { method:"POST", ... })
    });
