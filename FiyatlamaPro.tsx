...
const MENU = {
  ...
  katkiPayi:{title:"Katkı Payı Hesaplama",back:"ticariMenu"},
      ...
      <Card>
        ...
        <div style={{marginBottom:10}}>
          ...
          <select value={paraBirimi} onChange={e=>setParaBirimi(e.target.value)}
            style={{width:"100%",padding:"10px 12px",borderRadius:10,border:`1.5px solid ${C.border}`,background:"#fff",fontSize:14,fontWeight:700,color:C.blue,outline:"none"}}>
        ...
        {senaryolar.map((s,i)=>(
          <div key={i} style={{display:"flex",alignItems:"center",gap:8,marginBottom:8}}>
            <input value={s} onChange={e=>senaryoGuncelle(i,e.target.value)} placeholder="örn. 5 veya -5"
              inputMode="decimal"
              style={{flex:1,padding:"10px 12px",borderRadius:10,border:`1.5px solid ${C.border}`,background:"#fff",fontSize:14,fontWeight:600,outline:"none"}}/>
            <span style={{fontSize:13,color:C.sub,fontWeight:700}}>%</span>
            {senaryolar.length>1 && (
              <button onClick={()=>senaryoSil(i)} style={{background:"#FDEDED",border:"none",width:32,height:32,borderRadius:8,color:C.red,fontSize:16,cursor:"pointer"}}>×</button>
            )}
          </div>
        ))}
        ...
        <Card>
          ...
          {senaryoSonuclari.map((r:any,i)=>(
            <div key={i} style={{
              ...
              background:r.fark>=0?C.greenLight:"#FDEDED",
            }}>
              <div>
...
function HazineIslemleri(){
  const [ekran,setEkran]=useState<"menu"|"doviz"|"forward"|"swap"|"bono"|"senaryo">("menu");
  ...
  const ARACLAR=[
    ...
    {key:"bono" as const, icon:"📜", label:"Hazine Bonosu Getiri", desc:"İskontolu fiyat ve efektif getiri", renk:C.orange, bg:C.orangeLight},
    {key:"senaryo" as const, icon:"📊", label:"Kur Hareketi Senaryo", desc:"Pozisyon kâr/zarar simülasyonu", renk:C.green, bg:C.greenLight},
  ];
  ...
  if(ekran!=="menu"){
    ...
    return(
      <div style={{background:C.bg,minHeight:"100vh"}}>
        ...
        {ekran==="bono" && <HtHazineBonosu/>}
        {ekran==="senaryo" && <HtKurSenaryo/>}
      </div>
    );
  }
  ...
  return(
    <div style={{background:C.bg,minHeight:"100vh",paddingBottom:32}}>
      <div style={{background:"linear-gradient(135deg,#1C3A5E 0%,#2C5F8A 100%)",padding:"16px 16px 14px"}}>
        ...
        <p style={{margin:"4px 0 0",fontSize:11,color:"rgba(255,255,255,0.55)"}}>5 Araç</p>
      </div>
...
{/* ── HESAPLAMA ARAÇLARI ── */}
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6,marginBottom:10}}>
              {[
                ...
                {key:"ticariMenu",   icon:"🏢", label:"Tüzel\nFinansman Araçları",             count:"9 Araç", g1:"#7A5000",g2:"#B07D2E"},
              ].map((c,i)=>(
...
{/* ── KATILIM MENU ── */}
        ...
        {screen==="ticariMenu"&&(
          <div style={{padding:"0 16px 32px"}}>
            ...
            {menuItem("katkiPayi","🎁","Katkı Payı Hesaplama","",C.green,C.greenLight)}
          </div>
        )}
        ...
        {/* ── YASAL UYARI FOOTER ── */}
        {!["home","katilimMenu","finansmanMenu","ticariMenu","asistan","sozluk","finansalTakvim","finansalGostergeler","vadeTakibi","hazineIslemleri","piyasaHaberleri","ayarlar"].includes(screen)&&(
          <div style={{
