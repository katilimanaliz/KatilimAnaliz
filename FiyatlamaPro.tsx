...
function GetiriKarsilastirma(){
  const [aralik,setAralik]=useState("1yil");
...
function App(){
  ...
  // Kolon genişliği: telefon 430 → dizüstü 940 → geniş monitör 1120
  const kolonW=IS_NATIVE?680:(ekranW>=1440?1120:(ekranW>=1024?940:430));
  const altBarW=IS_NATIVE?560:(ekranW>=1440?700:(ekranW>=1024?640:402));
  useEffect(()=>{
    if(IS_NATIVE) return;
