  ...
  return(
    ...
    <div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Text',sans-serif",background:"#0F1923",minHeight:"100dvh",maxWidth:430,margin:"0 auto"}}>
      ...
      <div style={{paddingTop:0}}>
        ...
        {/* ── HOME ── */}
        {screen==="home"&&(
          <div style={{background:"#0F1923",padding:"10px 12px 0",paddingBottom:70,boxSizing:"border-box",display:"flex",flexDirection:"column",overflowY:"auto"}}>
        ...
        {screen==="hesaplaMenu"&&(()=>{
          ...
          return(
          <div style={{background:"#0F1923",padding:"12px 12px 0",paddingBottom:70,boxSizing:"border-box",overflowY:"auto"}}>
            {/* Arama çubuğu */}
