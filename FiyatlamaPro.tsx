...
function App(){
  ...
  return(
    <>
      ...
      `}</style>
    <div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Text',sans-serif",background:"#0F1923",minHeight:"100dvh",maxWidth:IS_NATIVE?"100%":430,margin:"0 auto"}}>
