...
function Leasing({s,onGecmis}){
  ...
  useEffect(()=>{
    if(r?.plan&&r.plan.length>0&&onGecmis){
      onGecmis({modul:"Finansal Kiralama",tutar:fmtTL(parseFloat(tutar)),vade:vade+" Ay",oran:oran+"%",sonuc:fmtTL(r?.toplamMaliyet),aylikTaksit:fmtTL(r?.pmt_kdv),plan:r?.plan,satirlar:raporSatirlari,showKdv:true});
    }
