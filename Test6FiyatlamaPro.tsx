...
const EVDS_GRUPLARI = [
  {
    ...
    seriler:{
      konut:"TP.KTF10", tasit:"TP.KTF11", ihtiyac:"TP.KTF12", katilma:null,
    }
  },
  {
    id:"kamu", label:"Kamu Bankaları", icon:"🏛️", renk:"#1565C0", bg:"#E3F2FD",
    seriler:{
      konut:"TP.KTF101", tasit:null, ihtiyac:null, katilma:null,
    }
  },
  {
    id:"katilim", label:"Katılım Bankaları", icon:"☪️", renk:"#B07D2E", bg:"#FBF5E8",
    seriler:{
      konut:"TP.KTF17", tasit:"TP.KTF171", ihtiyac:"TP.KTF172", katilma:null,
    }
  },
];
