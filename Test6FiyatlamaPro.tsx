...
function BistHisseTarayici() {
  ...
  const [siraBy, setSiraBy]             = useState<"fk"|"pddd"|"roe"|"temetu">("fk");
  ...
  return (
    <div style={{background:C.bg, padding:"12px 14px 80px", minHeight:"100%"}}>
      ...
      {yukleniyor ? (
        ...
        <div>
          {/* Tablo başlığı */}
          <div style={{display:"grid",gridTemplateColumns:"1fr 52px 48px 48px 48px 52px",gap:4,padding:"0 4px 6px",fontSize:9,fontWeight:700,color:C.sub,textTransform:"uppercase",letterSpacing:0.5,borderBottom:`1.5px solid ${C.border}`,marginBottom:2}}>
            <span>Hisse</span>
            <span style={{textAlign:"right"}}>Fiyat</span>
            <span style={{textAlign:"right"}}>F/K</span>
            <span style={{textAlign:"right"}}>PD/DD</span>
            <span style={{textAlign:"right"}}>ROE%</span>
            <span style={{textAlign:"right"}}>Tmt%</span>
          </div>
          ...
          {filtreli.map((h, i) => (
            <div key={h.ticker}>
              <div
                ...
                style={{
                  display:"grid",gridTemplateColumns:"1fr 52px 48px 48px 48px 52px",gap:4,
                  padding:"8px 4px",
                ...
                <div style={{textAlign:"right",fontSize:12,fontWeight:600,color:C.text}}>{fmt2(h.fk,1)}</div>
                <div style={{textAlign:"right",fontSize:12,fontWeight:600,color:C.text}}>{fmt2(h.pddd,1)}</div>
                <div style={{textAlign:"right",fontSize:12,fontWeight:600,color:h.roe&&h.roe>0?C.green:h.roe&&h.roe<0?C.red:C.text}}>{fmt2(h.roe,1)}</div>
                <div style={{textAlign:"right",fontSize:12,fontWeight:600,color:C.green}}>{h.temetu ? fmt2(h.temetu,1)+"%" : "—"}</div>
              </div>
