  ...
  return (
    <div style={{background:FC.bg,fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Text',sans-serif",color:FC.text,minHeight:"100%"}}>
      ...
      <div style={{display:"flex",alignItems:"center",padding:"6px 10px",background:"#111820",borderBottom:`1px solid ${FC.border}`,position:"sticky" as any,top:0,zIndex:10}}>
        ...
        <span style={{flex:1,fontSize:9,fontWeight:700,color:FC.sub,letterSpacing:0.5}}>FON ADI</span>
...
function BistHisseTarayici() {
  ...
  useEffect(() => {
    fetch("/api/hisse-proxy")
      .then(r => r.json())
      .then(d => {
        if (d.success) setHisseler(d.data);
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <div>
            ...
            <div style={{fontSize:11,color:C.sub}}>{filtreli.length} hisse · Midas · ⚠️ 15 dk gecikmeli</div>
          </div>
        </div>
        <div style={{textAlign:"right"}}>
