                ...
                <div key={fon.kod}>
                  ...
                  <div onClick={()=>handleFonTikla(fon)} style={{
                    ...
                    <div style={{flex:1,minWidth:0,paddingRight:2,textAlign:"left"}}>
                      <div style={{fontSize:11,fontWeight:800,color:"#e8f0fa",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",lineHeight:1.3}}>{fon.ad}</div>
...
function VadeTakibi(){
  ...
  function formKaydet(){
    ...
    const yeni={
      ...
      tutar:form.tutar?parseFloat(form.tutar.replace(",",".")):null,
      para:form.para,
  ...
  return(
    <div style={{paddingBottom:32}}>
      ...
      <div style={{background:"linear-gradient(135deg,#1A3A2A 0%,#2A5A3A 100%)",padding:"16px 16px 14px"}}>
        ...
        <h2 style={{margin:0,fontSize:18,fontWeight:800,color:"#fff"}}>Vade & Hatırlatma Takibi</h2>
      ...
      <div style={{padding:"10px 12px 0"}}>
        {/* Sekmeler */}
        <div style={{display:"flex",background:"rgba(255,255,255,0.05)",borderRadius:12,padding:3,marginBottom:12,gap:3}}>
          {([["liste","📋 Kayıtlar"],["ekle","➕ Yeni Ekle"]] as const).map(([s,l])=>(
            <button key={s} onClick={()=>setAktifSekme(s)} style={{
              ...
              color:aktifSekme===s?"#fff":"rgba(255,255,255,0.45)",
              fontWeight:aktifSekme===s?700:500,fontSize:12,cursor:"pointer",
            }}>{l}</button>
          ))}
        </div>
        ...
        {aktifSekme==="liste"&&(<>
          ...
          <div style={{display:"flex",gap:6,marginBottom:10,overflowX:"auto"}}>
            {([["tumu","Tümü"],["katilim","🏦 Katılım"],["kredi","💳 Kredi"],["not","📌 Not"]] as const).map(([v,l])=>(
              <button key={v} onClick={()=>setFiltre(v)} style={{
                ...
                background:filtre===v?"#2A5A3A":"rgba(255,255,255,0.07)",
                color:filtre===v?"#fff":"rgba(255,255,255,0.45)",
                fontWeight:filtre===v?700:500,fontSize:11,cursor:"pointer",
              }}>{l}</button>
            ))}
          </div>
          ...
          {filtreli.length===0?(
            <div style={{textAlign:"center",padding:"40px 20px",color:"rgba(255,255,255,0.3)"}}>
              ...
              <p style={{fontSize:13}}>Henüz kayıt yok</p>
        ...
        {aktifSekme==="ekle"&&(
          <div style={{background:"#1A2633",borderRadius:14,padding:16}}>
            ...
            {form.tip!=="not"&&(<>
              ...
              <div style={{display:"flex",gap:6,marginBottom:10}}>
                <input value={form.tutar} onChange={e=>setForm(p=>({...p,tutar:e.target.value}))}
            ...
            <input value={form.vade} onChange={e=>setForm(p=>({...p,vade:e.target.value}))}
              type="date" style={{...INP,marginBottom:12,colorScheme:"dark"}}/>
...
const MENU = {
  ...
  vadeTakibi:{title:"Vade & Hatırlatma Takibi",back:"home"},
...
const MENU_ARAMA_LIST=[
  ...
  {key:"vadeTakibi",         label:"Vade & Hatırlatma Takibi",             icon:"⏰", grup:"Araçlar"},
...
{/* ── HESAPLAMA ARAÇLARI ── */}
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6,marginBottom:10}}>
              {[
                ...
                {key:"vadeTakibi",    icon:"⏰", label:"Vade &\nHatırlatma",     g1:"#1A4A2A",g2:"#2A6A3A"},
...
{/* ── KATILIM MENU ── */}
        ...
        {/* ── YASAL UYARI FOOTER ── */}
        {!["home","katilimMenu","finansmanMenu","ticariMenu","asistan","sozluk","finansalTakvim","finansalGostergeler","oranKarsilastirma","vadeTakibi","ayarlar"].includes(screen)&&(
          <div style={{
