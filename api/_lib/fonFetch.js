...
//
// DEĞİŞİKLİK (2026-09-04) — "TÜM FONLAR" DENEMESİ GERİ ALINDI:
// Yatırım Fonları Getiri İzleme ekranına "Tümü" filtresi için katılım
// filtresiz büyük-limit tek istek denendi (?limit=5000, sayfalamaya hiç
// gidilmeden). Canlı sonuç: gerçek evren 3.486 fon, TEK istek 2.925 kota
// harcadı (Fonoloji'nin ücretsiz planı aylık 15.000 istek) — bu, "Tümü"yü
// düzenli tazelemeyi sürdürülemez kılıyor. Deneme kodu GERİ ALINDI, ekran
// şimdilik sadece katılım fonlarını (bu dosyanın asıl işi) gösteriyor.
